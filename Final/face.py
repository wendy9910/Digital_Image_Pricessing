...
parser.add_argument('--eyes_cascade', help='Path to eyes cascade.',
                    default='C:/Users/88691/數位影像處理/HW/期末作品/opencv/data/haarcascades/haarcascade_eye.xml')
parser.add_argument(
...
if not face_cascade.load('data/haarcascades/haarcascade_frontalface_alt.xml'):
    ...
    exit(0)
if not eyes_cascade.load('ata/haarcascades/haarcascade_eye_tree_eyeglasses.xml'):
